...
export function createLoadingComponent(options: LoadingOptionsResolved): LoadingInstance {
  ...
  const sLoadingComponent = defineComponent({
    name: 'SLoading',
    setup(_, { expose }) {
  ...
  const loadingInstance = createApp(sLoadingComponent)
